<template>
  <div class="mx-auto max-w-5xl py-10">
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
      ...
      <a href="/docs" class="card-compact cursor-pointer rounded-2xl bg-white p-6 transition-all hover:border-blue-200">
...
import { TrendingUpFilled, PowerFilled } from "@vicons/material";
